...
export const Students: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={editingId ? `Edit ${t('students')}` : `New ${t('students')}`}>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="input-group">
            ...
            <select className="input bg-white" value={formData.assigned_group_id} onChange={e => setFormData({...formData, assigned_group_id: e.target.value})}>
