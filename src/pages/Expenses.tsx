        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="input-group">
              ...
              <select className="input bg-white" value={formData.category} onChange={e => setFormData({...formData, category: e.target.value})}>
                {categories.map(c => (
                  <option key={c} value={c}>{c}</option>
                ))}
              </select>
          ...
          <div className="input-group">
            ...
            <input type="text" required className="input" placeholder="e.g. November Electricity Bill" value={formData.description} onChange={e => setFormData({...formData, description: e.target.value})} />
          </div>
